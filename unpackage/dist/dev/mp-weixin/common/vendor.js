...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getDictArr = exports.getDict = exports.dictArr = exports.default = void 0;var _default = {
...
var dictArr = {
  ...
  { value: 5, content: '当你回答问题时,请想象你是身处于平常工作生活环境中的自己。这不是考试，没有对错，你只需要根据直觉诚实的回答哦，如果两个版本结果有出入，请以完整版结果为准。选择版本然后开始吧' }] };exports.dictArr = dictArr;



var getDict = function getDict(key) {
  var arr = dictArr[key];
  var dict = {};
  for (var i = 0; i < arr.length; i++) {
...
var getDictArr = function getDictArr(key) {
  return dictArr[key];
};exports.getDictArr = getDictArr;

var dicts = { dictArr: dictArr, getDict: getDict, getDictArr: getDictArr };
